...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Circle - Thanh toán đơn hàng</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3 class="text-capitalize">Thanh toán thành công !</h3>
                                    <p class="text-muted mt-2"> Thông tin đơn hàng đã được gửi đến <span class="font-weight-medium">{{ $email }}</span>.
                                    Quý khách có thể xem đơn hàng của mình trong Email. </p>

                                    <a href="{{ url('') }}" class="btn btn-block btn-primary waves-effect waves-light mt-3 text-capitalize">Quay về trang chủ</a>
                                </div>
