    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title text-uppercase">Cập nhật nhà cung cấp</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <form action="{{ route('adminProducerPostEdit', $row['id']) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="dropify" name="thumb" data-default-file="<?= $row['thumb'] == 'default.jpg' ? url('uploads/' . $row['thumb']) : url('uploads/producer/'.$row['thumb']) ?>">
