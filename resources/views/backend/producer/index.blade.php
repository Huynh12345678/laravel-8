...
@section('title', 'Xem danh sách nhà cung cấp')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);" class="text-capitalize">nhà cung cấp</a></li>
                        <li class="breadcrumb-item active text-capitalize">Xem danh sách</li>
                    </ol>
                </div>
                <h4 class="page-title text-uppercase">Danh sách nhà cung cấp</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
