...
@section('title', 'Xem danh sách thùng rác danh mục sản phẩm')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Xem thùng rác</li>
                    </ol>
                </div>
                <h4 class="page-title text-uppercase">Danh sách thùng rác danh mục</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
