    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title text-uppercase">Cập nhật danh mục</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <form action="{{ route('adminCatalogPostEdit', $row['id']) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="dropify" name="thumb" data-default-file="<?= $row['thumb'] == 'default.jpg' ? url('uploads/' . $row['thumb']) : url('uploads/catalog/'.$row['thumb']) ?>">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control @error('meta_title') parsley-error @enderror" name="meta_title"
                            rows="5">{{ old('meta_title') ? old('meta_title') : $row['meta_title'] }}</textarea>
                        @error('meta_title')
                        <ul class="parsley-errors-list filled">
                            <li class="parsley-required">{{ $message }}</li>
                        </ul>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control @error('meta_keyword') parsley-error @enderror" name="meta_keyword"
                            rows="5">{{ old('meta_keyword') ? old('meta_keyword') : $row['meta_keyword'] }}</textarea>
