    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title text-uppercase">Cập nhật Slider</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->

    <a href="{{ route('adminSlider') }}" class="btn btn-danger waves-effect waves-light mb-4"><i
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <form action="{{ route('adminSliderPostEdit', $row['id']) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <input type="hidden" name="thumbOld" value="{{ $row['thumb'] }} ">
                    <div class="form-row">
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <label class="text-capitalize">Tiêu đề Slider</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="dropify" name="thumb" data-default-file="<?= $row['thumb'] == 'default.jpg' ? url('uploads/' . $row['thumb']) : url('uploads/slider/'.$row['thumb']) ?>">
