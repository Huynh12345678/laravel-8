...
@section('title', 'Xem danh sách thương hiệu')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);" class="text-capitalize">thương hiệu</a></li>
                        <li class="breadcrumb-item active text-capitalize">Xem danh sách</li>
                    </ol>
                </div>
                <h4 class="page-title text-uppercase">Danh sách thương hiệu</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
