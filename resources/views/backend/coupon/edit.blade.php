    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title text-uppercase">Cập nhật Coupon</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <form action="{{ route('adminCouponPostEdit', $row['id']) }}" method="POST">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label class="text-capitalize">Mã code</label>
                                <input type="text" value="{{ old('code') ? old('code') : $row['code'] }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ old('price_discount') ? old('price_discount') : $row['price_discount'] }}"
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ old('code_limit') ? old('code_limit') : $row['code_limit'] }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ old('expiration_date') ? old('expiration_date') : $row['expiration_date'] }}"
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ old('price_payment_limit') ? old('price_payment_limit') : $row['price_payment_limit'] }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ old('code_description') ? old('code_description') : $row['code_description'] }}"
