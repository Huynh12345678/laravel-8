...
@section('title', 'Xem danh sách coupon')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);" class="text-capitalize">coupon</a></li>
                        <li class="breadcrumb-item active text-capitalize">Xem danh sách</li>
                    </ol>
                </div>
                <h4 class="page-title text-uppercase">Danh sách coupon</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->

    <a href="{{ route('adminCouponAdd') }}" class="btn btn-primary waves-effect waves-light mb-4"><i
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item['status'] == 1)
                                            <a href="{{ route('adminCouponStatus', $item['id']) }}"
