            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        ...
                        <form action="{{ route('userPostResetPassword', $row['id']) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label class="text-capitalize">Mật khẩu cũ</label>
                                <input type="password" class="form-control @error('passwordOld') is-invalid @enderror" name="passwordOld">
