...
@section('metaSeo')
    ...
    <meta name="description" content="Circle – Mua gì cũng có, giá khỏi phải lo ✅ SHOPPING ONLINE Mua Bán Thời Trang Nam Nữ, Thế Giới Di Động - LAPTOP ✨ Khuyến Mãi Hấp Dẫn ✨ Miễn Phí Vận Chuyển ✨ Sàn TMĐT tập đoàn FPT ✅ Mua Bán Online, Mua Hàng Đảm Bảo Chất Lượng ✅ Giá Rẻ Từ Shop Uy tín" />
    ...
    <meta name="og:description" content="Circle – Mua gì cũng có, giá khỏi phải lo ✅ SHOPPING ONLINE Mua Bán Thời Trang Nam Nữ, Thế Giới Di Động - LAPTOP ✨ Khuyến Mãi Hấp Dẫn ✨ Miễn Phí Vận Chuyển ✨ Sàn TMĐT tập đoàn FPT ✅ Mua Bán Online, Mua Hàng Đảm Bảo Chất Lượng ✅ Giá Rẻ Từ Shop Uy tín" />
@endsection
                    ...
                    <div class="col-lg-9">
                        <div class="section__category-product mt-4 mt-lg-0">
                           ...
                           <div class="section__category-emty mt-5 text-center">
                            ...
                            {!! str_replace("?page=", "/page/",preg_replace("@/page/([0-9]+)@","",str_replace("?page=1\"", "\"",$listProductNews->links('frontend.page.page')))) !!}
    ...
    <script>
        $(function() {
            ...
            $(document).on('change', '#filter', function() {
                ...
                $.ajax({
                    url: "{{ route('userProductShopFilter') }}",
                    type: "post",
                    data: {
                        filter: filter,
                    },
